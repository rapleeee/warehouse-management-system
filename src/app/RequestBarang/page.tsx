...
const RequestBarang = () => {
    ...
    const [requests, setRequests] = useState([
        { id: 1, nama: "LED Sinyal Langsir Putih", departemen: "Divre IV", pengaju: "Budi", posisi: "Staff", jumlah: 5, status: "Pending" },
        { id: 2, nama: "Radio Lokomotif", departemen: "Daop 1", pengaju: "Ani", posisi: "Supervisor", jumlah: 10, status: "Approved" },
        { id: 3, nama: "Sentil", departemen: "Daop 2", pengaju: "Rudi", posisi: "Manager", jumlah: 15, status: "Approved" },
    ]);
